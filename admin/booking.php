...
<body>
    ...
    <div id="width">
        <?php
            $sql="SELECT * FROM `conference` WHERE `status`='pending'";
...
?>
            ...
            <tr>
                  ...
                  <td><a id="anchor1" href="approve.php?email=<?php echo $results['email']; ?>"><button class="btn">Approve</button></a></td>
                  <td><a id="anchor1" href="decline.php?email=<?php echo $results['email']; ?>"><button class="btn1">Decline</button></a></td>
            </tr>
